    ...
    <div className={css.onboard_container}>
      ...
      <div className={css.photo_file_wrapper}>
        ...
        <button
          ...
          onClick={() =>
            (
              document.getElementById("fileInput") as HTMLInputElement | null
            )?.click()
          }
        >
          Завантажити фото
      ...
      <form action="" className={css.edit_form}>
        <div className={css.inputs}>
          <label htmlFor="sex" className={css.label_cont}>
            ...
            <Select options={OPTIONS} id="sex" instanceId="sex-select" />
          </label>
          ...
          <label htmlFor="dateOfBirth" className={css.label_cont}>
            ...
            <input type="date" className={css.dateSelect} id="dateOfBirth" />
          </label>
        </div>
